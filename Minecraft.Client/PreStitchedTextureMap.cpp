...
void PreStitchedTextureMap::loadUVs(int width, int height)
{
	...
	if(iconType != Icon::TYPE_TERRAIN)
	{
		...
		ADD_ICON(10,	1,	L"arrowStaff")
		ADD_ICON(10,	2,	L"dragonBreath")
        ...
        ADD_ICON(11,	1,	L"arrowTip")
        ADD_ICON(11,	2,	L"lingeringBottle")
		...
		ADD_ICON(12,	2,	L"beetrootSeeds")
		ADD_ICON(12,	3,	L"beetrootStew")
        ...
        ADD_ICON(13, 7, L"commandMinecart")
        ...
        ADD_ICON(13, 15, L"horseArmor");
		

		ADD_ICON(14,	0,	L"barrier2")
		ADD_ICON(14,	1,	L"skull_wither")
		ADD_ICON(14,	2,	L"totem")
		ADD_ICON(14,	3,	L"shulkerShell")
		ADD_ICON(14,	4,	L"ironNugget")
        ...
        ADD_ICON(15,		12, L"bucketCod")
        ADD_ICON(15,		13, L"bucketSalmon")
        ADD_ICON(15,		14, L"bucketPufferfish")
        ADD_ICON(15,		15, L"bucketTropical")
